	...
	<div class="card-body  p-lg-4">
		...
		<div class="card mb-4">
			<div class="card-header p-0">
				...
				<li class="nav-item">
				<a class="nav-link px-4 py-3 active rounded-0" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">按项目版本</a>
				</li>			
				</ul>
			</div>
...
<!-- 按照项目排列，显示项目清单（规则：当100%时可点击创建测试报告） -->	
