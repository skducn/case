					...
					if rs2.eof then
						...
						do while not rs2.eof 
							...
							if rs78.recordcount > 0 then %>
								<li><a href="testcase-<%=rs1("pjtId")%>-<%=rs2("platformId")%>-<%=rs7("lblId")%>-1.html"><i class="fa fa-circle-o text-yellow"></i> <%=rs2("platformName")%> </a></li>
							<%elseif rs79.recordcount > 0 then%>
								<li><a href="testcase-<%=rs1("pjtId")%>-<%=rs2("platformId")%>-<%=rs7("lblId")%>-2.html"><i class="fa fa-circle-o text-yellow"></i> <%=rs2("platformName")%> </a></li>												
							<%else%>
								<li><a href="testcase-<%=rs1("pjtId")%>-<%=rs2("platformId")%>-<%=rs7("lblId")%>-3.html"><i class="fa fa-circle-o text-yellow"></i> <%=rs2("platformName")%> </a></li>
							<% end if
							rs7.close
						    rs79.close
						    rs78.close
