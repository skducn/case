...
<div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><i class="fa fa-align-justify"></i> <a href="review.html"> Home</a></li>
      </ol>
    </section>
		...
		<div class="box-header with-border">
			<div class="row">
				...
				<!-- 切换环境 -->
					...
					<li role="presentation"><a role="menuitem" tabindex="-1" href="reviewtestcase-<%=pjtId%>-<%=platformId%>-<%=lblId_array(varcount)%>-1.html">冒烟测试</a></li>
					<li role="presentation"><a role="menuitem" tabindex="-1" href="reviewtestcase-<%=pjtId%>-<%=platformId%>-<%=lblId_array(varcount)%>-2.html">正式测试</a></li>
					<li role="presentation"><a role="menuitem" tabindex="-1" href="reviewtestcase-<%=pjtId%>-<%=platformId%>-<%=lblId_array(varcount)%>-3.html">回归测试</a></li>
					</ul>
